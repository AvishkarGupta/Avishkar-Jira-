      ...
      <div className="mt-17 w-[80%] ">
        ...
        <div id="filter" className="bg-gray-100 rounded m-[1rem] flex justify-evenly flex-wrap">
          <div className="mx-[1rem] my-[1rem] bg-violet-700 text-white font-semibold px-2 py-1 rounded-xl text-[0.8rem]">
            ...
            >
            <option 
              className="text-violet-700 font-semibold bg-transparent" 
              value={filter?.filter?.owner}
            >
              {filter?.filter?.owner}
            </option>
            {user.data 
          ...
          <div className="mx-[1rem] my-[1rem] bg-blue-400 text-white font-semibold px-2 py-1 rounded-xl text-[0.8rem]">
            ...
            >
            <option 
              className="text-blue-400 font-semibold bg-transparent" 
              value={filter?.filter?.assignee}
            >
          ...
          <div className="mx-[1rem] my-[1rem] bg-yellow-400 text-white font-semibold px-2 py-1 rounded-xl text-[0.8rem]">
            ...
            >
            <option 
              className="text-yellow-400 font-semibold bg-transparent" 
          ...
          <div className="mx-[1rem] my-[1rem] bg-green-700 text-white font-semibold px-2 py-1 rounded-xl text-[0.8rem]">
            ...
            >
            <option 
              className="text-green-700 font-semibold bg-transparent" 
          ...
          <div>
            <button 
              // onClick={handleClear} 
              className="mx-[1rem] my-[1rem] bg-fuchsia-700 text-white font-semibold px-2 py-1 rounded-xl text-[0.8rem]">
              Clear
            </button>
          </div>
          <div>
            <button 
              ...
              className="mx-[1rem] my-[1rem] bg-orange-700 text-white font-semibold px-2 py-1 rounded-xl text-[0.8rem]">
              Filter
            </button>
          </div>
        </div>
        <div id="taskDiv" className=" flex flex-wrap justify-evenly overflow-y-scroll max-h-[50rem]">
          <FilteredTaskBoilerPlate data={data}/> 
        </div>
      </div>
    </div>
    <Footer/>
...
export default FilterTasksById;